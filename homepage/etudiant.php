		...
		<!-- Highlights -->
			<section class="wrapper">
                ...
                <?php 
                            ...
                            echo "<br>";
                            $sql = "SELECT name,id FROM users WHERE travaille='etudiant(e)' ";
                           ...
                           <section>
							<div class='content'>
								<header>
									<a href='otherprofile.php?id=".$row["id"]."' ><img src='./images/et.png' width='200px'></span></a>
									<h3> <a href='otherprofile.php?id=".$row["id"]."' >".$row["name"]."</a></h3>
								</header>
							</div>
						    </section>
                           ";
